    ...
    upgrades: {
        screen1: {
            ...
            nodes: [
                ...
                { id: 'dmg5', label: 'Damage V', type: 'damage', maxLevel: 10, valuePerLevel: 20, costPerLevel: 3, col: 5, row: 2, requires: 'skillEssence2' },
                ...
                { id: 'dmg6', label: 'Damage VI', type: 'damage', maxLevel: 10, valuePerLevel: 25, costPerLevel: 6, col: 5, row: 1, requires: 'aspd3' },
